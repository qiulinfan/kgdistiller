...
class StressWorkflowHarnessTest(unittest.TestCase):
    def test_small_disposable_stress_run(self) -> None:
        ...
        self.assertEqual(["latex", "markdown", "typst"], report["formats"])
        self.assertEqual("json-memory", report["query"]["backend"])
        self.assertTrue(report["query"]["graph_byte_stable"])
        self.assertEqual(0, report["sqlite_files"])
        ...
        self.assertEqual("json-memory", report["transaction"]["query_backend"])
    ...
    def test_small_query_only_stress_run(self) -> None:
        ...
        self.assertEqual(20, report["final_knowledge_nodes"])
        self.assertEqual(0, report["sqlite_files"])
